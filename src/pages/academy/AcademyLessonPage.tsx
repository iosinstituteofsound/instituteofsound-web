...
import { AcademyLessonMediaSidebar } from '@/components/academy/AcademyLessonMediaSidebar'
...
export default function AcademyLessonPage() {
  ...
  const hasMedia = getLessonVideos(data).length > 0

  return (
    <AcademyLessonShell lesson={data} wide={hasMedia}>
      ...
      <div className={`academy-lesson-layout${hasMedia ? ' academy-lesson-layout-split' : ''}`}>
        <div className="academy-lesson-main">
        ...
        {hasMedia && <AcademyLessonMediaSidebar lesson={data} />}
      </div>
    </AcademyLessonShell>
  )
}
