        ...
        >
          ...
          <span className="messenger-chat-window__meta">
            <span className="messenger-chat-window__name-row">
              <span className="messenger-chat-window__name">{thread?.otherName ?? 'Loading…'}</span>
      ...
      {!minimized ? (
        <>
          <div className="messenger-chat-window__body">
              ...
              {messages.length <= 2 ? (
                <div className="messenger-chat-window__hero">
                  <FeedUserAvatar
                    ...
                    className="h-16 w-16"
                  />
                  <div className="messenger-chat-window__hero-name">{thread?.otherName ?? 'Chat'}</div>
                </div>
              ) : null}
            ...
            {typingUsers.length ? (
              <p className="messenger-chat-window__typing">{thread?.otherName ?? 'User'} is typing…</p>
            ) : null}
          </div>
