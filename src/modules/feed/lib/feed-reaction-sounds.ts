...
let lastPlayedKind: FeedReactionKind | null = null
let lastPlayedAt = 0
...
const SOUND_PLAYERS: Record<FeedReactionKind, (ctx: AudioContext, t: number) => void> = {
  like: (ctx, t) => {
    playPop(ctx, t, 0.16)
...
export async function playReactionSound(kind: FeedReactionKind) {
