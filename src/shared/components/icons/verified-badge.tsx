...
/** Verified seal + checkmark (viewBox 92 0 24 24). */
const SEAL_PATH =
...
const VERIFIED_BADGE_FILL = '#1877F2'
...
export function VerifiedBadge({ size = 'md', className, title = 'Verified' }: VerifiedBadgeProps) {
  ...
  return (
    ...
    >
      <title>{title}</title>
      <path d={SEAL_PATH} fill={VERIFIED_BADGE_FILL} />
