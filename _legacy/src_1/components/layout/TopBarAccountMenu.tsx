...
import { homeDashboardPath, roleLabel, hasArtistAccess } from '@/lib/auth/roles'
...
export function TopBarAccountMenu() {
  ...
  const dashboardPath = homeDashboardPath(user.authorization)
          ...
          <div className="v2-account-menu__hero">
            ...
            <div className="v2-account-menu__identity v2-account-menu__identity--active">
              ...
              <span className="v2-account-menu__who">
                ...
                <span>
                  {roleLabel(user.authorization)} · @{networkHandle}
                </span>
              </span>
