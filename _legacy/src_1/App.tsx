        ...
        <Routes>
          <Route element={<AppShell />}>
            ...
            <Route
              path="member/upgrade"
              element={
                <ProtectedRoute anyPermission={['artist.edit', 'artist.view']}>
            ...
            <Route
              ...
              element={
                <ProtectedRoute anyPermission={['artist.view', 'artist.edit']}>
                  <ArtistDashboardPage />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute
                  anyPermission={['submissions.review', 'articles.view', 'permissions.manage']}
                >
                  <EditorDashboardPage />
                </ProtectedRoute>
              }
